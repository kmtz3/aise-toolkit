...
| `/log-feedback [customer or topic]` | Discover outstanding Planhat product-feedback Tasks (created by `post-session-debrief`), draft structured Productboard GTM feedback notes, and submit with HITL confirmation on customer mapping and content before each submission. |
