---
name: assistant-help
description: Quick reference of all available commands in the aise-leadership plugin, grouped by workflow stage. Run anytime you forget what's available or want to know what to run next.
---
